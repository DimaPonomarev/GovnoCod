...
extension UIViewPoeTTT {
    ...
    public func onClick_TOC(target: Any, _ selector: Selector) {
    ...
    public func fadeIn(duration: TimeInterval = 0.0, delay: TimeInterval = 0.0, completion: @escaping ((Bool) -> Void) = {(finished: Bool) -> Void in }) {
        self.alpha = 0.0
    ...
    public  func fadeOut(duration: TimeInterval = 0.0, delay: TimeInterval = 0.0, completion: @escaping (Bool) -> Void = {(finished: Bool) -> Void in }) {
        self.alpha = 1.0
...
typealias UILabelPoeTTT = UILabel

extension UILabelPoeTTT {
    func setShadow(){
...
typealias StringPoeTTT = String

extension StringPoeTTT {
...
typealias UIApplicationPoeTTT = UIApplication

extension UIApplicationPoeTTT {
...
typealias UICollectionViewPoeTTT = UICollectionView

extension UICollectionViewPoeTTT {
